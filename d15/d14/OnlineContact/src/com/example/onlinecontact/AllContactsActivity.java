...
public class AllContactsActivity extends ListActivity {
	...
	private static String url_all_contact = "http://10.50.21.21/android_contact/all_contacts.php";
	...
	class LoadAllContact extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			JSONObject json = jParser.makeHttpRequest(url_all_contact, "GET", params);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							AllContactsActivity.this, usersList,
							R.layout.list, new String[] { TAG_ID,
									TAG_NAME},
